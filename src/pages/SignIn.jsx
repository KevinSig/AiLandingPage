    ...
    <main className="flex">
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          ...
          <div className="px-5 sm:px-6">
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-6">
                {/* Logo */}
                <Link className="inline-flex text-blue-600 transition duration-150 ease-in-out" to="/" aria-label="Cruip">
              ...
              <h1 className="h2 font-asap-display text-slate-800 mb-12">Sign in to Tidy</h1>
              ...
              <form>
                ...
                <div className="text-center mt-5">
                  <Link className="text-blue-600 hover:underline" to="/reset-password">Forgot your password?</Link>
                </div>
              </form>
      ...
      <div className="relative hidden md:block md:w-1/2 bg-slate-900" aria-hidden="true">
        ...
        <div className="absolute inset-0" data-aos="fade">
          <img className="opacity-10 w-full h-full object-cover" src={PageBG} width="760" height="900" alt="Background" />
        </div>
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6">
            <div className="w-full max-w-lg mx-auto">
              <h2 className="h3 md:text-4xl font-asap-display text-slate-100 mb-4">The Wealth Inc.</h2>
              <div className="space-y-3">
              ...
              <div className="flex items-center mt-4">
                <Link to="#0">
                  <img className="rounded-full shrink-0 mr-3" src={CustomerAvatar} width="32" height="32" alt="Customer Avatar 05" />
                </Link>
