      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 font-asap-display text-slate-100 mb-4">Several People Are Typing</h1>
            ...
            <form>
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md">
                ...
                <button className="btn text-white bg-blue-600 hover:bg-blue-700" href="#0">Subscribe</button>
              </div>
              {/* Success message */}
