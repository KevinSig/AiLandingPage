          ...
          <div className="max-w-xl mx-auto md:max-w-none space-y-20">
            ...
            <div className="flex flex-col-reverse md:flex-row-reverse md:items-center md:space-x-reverse lg:space-x-reverse xl:space-x-reverse md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-4 space-y-reverse md:space-y-0">
              ...
              <div className="md:min-w-[30rem]" data-aos="fade-left">
                <h2 className="h3 md:text-4xl font-asap-display mb-4">
                  <Link className="text-slate-800 hover:underline hover:decoration-blue-100" to="/wall-of-love-single">Black Inc.</Link>
                </h2>
                ...
                <div className="space-y-3">
                  ...
                  <blockquote className="font-asap-display text-slate-500 italic">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur e xcepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.</blockquote>
                </div>
                <div className="flex items-center mt-4">
                  <Link to="#0">
                    <img className="rounded-full shrink-0 mr-3" src={CustomerAvatar01} width="32" height="32" alt="Customer Avatar 01" />
                  </Link>
                  <div className="font-medium">
                    <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Christine Duck</Link>
              ...
              <div className="flex justify-center items-center" data-aos="fade-right">
                <div className="relative">
                  ...
                  <img className="mx-auto md:max-w-none" src={Customers01} width="540" height="405" alt="Customer 01" />
                </div>
            ...
            <div className="flex flex-col-reverse md:flex-row md:items-center md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-4 space-y-reverse md:space-y-0">
              ...
              <div className="md:min-w-[30rem]" data-aos="fade-left">
                <h2 className="h3 md:text-4xl font-asap-display mb-4">
                  <Link className="text-slate-800 hover:underline hover:decoration-blue-100" to="/wall-of-love-single">Leon Fibre S.r.l.</Link>
                </h2>
                ...
                <div className="flex items-center mt-4">
                  <Link to="#0">
                    <img className="rounded-full shrink-0 mr-3" src={CustomerAvatar02} width="32" height="32" alt="Customer Avatar 02" />
                  </Link>
                  <div className="font-medium">
                    <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Marco Tancredi</Link>
                    <span className="text-slate-300"> · </span>
              ...
              <div className="flex justify-center items-center" data-aos="fade-right">
                <div className="relative">
                  <div className="absolute inset-0 pointer-events-none border-2 border-slate-200 translate-x-4 -translate-y-4 -z-10" aria-hidden="true"></div>
                  <img className="mx-auto md:max-w-none" src={Customers02} width="540" height="405" alt="Customer 02" />
                </div>
                <button className="absolute group">
                  <svg className="w-16 h-16 fill-current sm:w-20 sm:h-20 group" viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
                    <circle className="text-white opacity-80 group-hover:opacity-100 transition duration-150 ease-in-out" cx="44" cy="44" r="44" />
            ...
            <div className="flex flex-col-reverse md:flex-row-reverse md:items-center md:space-x-reverse lg:space-x-reverse xl:space-x-reverse md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-4 space-y-reverse md:space-y-0">
              ...
              <div className="md:min-w-[30rem]" data-aos="fade-left">
                <h2 className="h3 md:text-4xl font-asap-display mb-4">
                  <Link className="text-slate-800 hover:underline hover:decoration-blue-100" to="/wall-of-love-single">CD International</Link>
                </h2>
                <p className="text-lg text-slate-500 border-l-2 border-slate-800 pl-4 mb-8">Award-winning design firm Black Inc. didn't get the personalized approach they wanted from colloboration tools - until they met Tidy.</p>
                <div className="space-y-3">
                  <svg className="fill-blue-600" width="20" height="16" viewBox="0 0 20 16">
                ...
                <div className="flex items-center mt-4">
                  <Link to="#0">
                    <img className="rounded-full shrink-0 mr-3" src={CustomerAvatar03} width="32" height="32" alt="Customer Avatar 03" />
                  </Link>
                  <div className="font-medium">
                    <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Štefan Štefančík</Link>
                    <span className="text-slate-300"> · </span>
              ...
              <div className="flex justify-center items-center" data-aos="fade-right">
                <div className="relative">
                  <div className="absolute inset-0 pointer-events-none border-2 border-slate-200 -translate-x-4 -translate-y-4 -z-10" aria-hidden="true"></div>
                  <img className="mx-auto md:max-w-none" src={Customers03} width="540" height="405" alt="Customer 03" />
                </div>
                <button className="absolute group">
                  <svg className="w-16 h-16 fill-current sm:w-20 sm:h-20 group" viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
                    <circle className="text-white opacity-80 group-hover:opacity-100 transition duration-150 ease-in-out" cx="44" cy="44" r="44" />
