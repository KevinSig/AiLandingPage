                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage01} width="32" height="32" alt="Avatar 01" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage02} width="32" height="32" alt="Avatar 02" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage03} width="32" height="32" alt="Avatar 03" />
                    </div>
                    <div className="grow text-sm font-medium text-slate-600"><Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">4 Articles</Link> written by <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Anna L.</Link>, and 2 others</div>
                  </footer>
                </div>
              </div>
            </article>
              ...
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage01} width="32" height="32" alt="Avatar 01" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage04} width="32" height="32" alt="Avatar 04" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage05} width="32" height="32" alt="Avatar 05" />
                    </div>
                    <div className="grow text-sm font-medium text-slate-600"><Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">7 Articles</Link> written by <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Anna L.</Link>, and 2 others</div>
                  </footer>
                </div>
              </div>
            </article>
            ...
            <article className="bg-white p-6 md:px-8 shadow-lg" data-aos="fade-up" data-aos-anchor="[data-aos-id-support]" data-aos-delay={200}>
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage06} width="32" height="32" alt="Avatar 06" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage02} width="32" height="32" alt="Avatar 02" />
                      <img className="rounded-full border-2 border-white box-content" src={AvatarImage03} width="32" height="32" alt="Avatar 03" />
                    </div>
                    <div className="grow text-sm font-medium text-slate-600"><Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">2 Articles</Link> written by <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Kevin P.</Link>, and 2 others</div>
                  </footer>
                </div>
              </div>
            </article>
              ...
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    ...
                    <div className="grow text-sm font-medium text-slate-600"><Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">2 Articles</Link> written by <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Anna L.</Link></div>
                  </footer>
                </div>
              </div>
            </article>
              ...
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <footer className="flex items-center">
                    ...
                    <div className="grow text-sm font-medium text-slate-600"><Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">5 Articles</Link> written by <Link className="text-slate-800 hover:text-blue-600 transition duration-150 ease-in-out" to="#0">Anna L.</Link>, and 2 others</div>
                  </footer>
                </div>
              </div>
            </article>
