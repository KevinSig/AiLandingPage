      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6'>
        <div className='py-12 md:py-20 border-t border-slate-200'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            <h2 className='h2 font-asap-display text-slate-800'>
              Plugs right into the Shopify Chekcout
            </h2>
          </div>
          ...
          <div className='max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0'>
            {/* Tabs items (images) */}
            <div
              className='md:rtl md:w-5/12 lg:w-1/2 order-1 md:order-none'
              data-aos='fade-down'
              ref={tabs}
            >
            ...
            <div className='md:w-7/12 lg:w-1/2' data-aos='fade-up'>
              <div className='mb-8 text-center md:text-left'>
                <h3 className='h3 text-slate-800 font-asap-display mb-3'>
                  First of its kind.
                </h3>
                <p className='text-xl text-slate-500'>
                For the first time ever, Shopify has opened up their API for the checkout and post purchase page. 
                AI Upsell is the first and only checkout and post purchase solution made for Shopify Plus merchants. It makes product recommendations in the checkout . 
                </p>
              </div>
              {/* Tabs buttons */}
              <div className='mb-8 md:mb-0'>
                ...
                >
                  ...
                  <div>
                    ...
                    Upsell/cross-sell and post purchase offers can increase average order value by <b>20%</b>
                    </div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    ...
                    <div className='text-slate-500'>
                    Every second decreased from the checkout page speed can increase conversion rate by <b>5%</b>
                    </div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    ...
                    <div className='text-slate-500'>
                    AI makes <b>smarter</b> product recommendations that match a buyers taste & preferences
                    </div>
                  </div>
                </button>
              </div>
