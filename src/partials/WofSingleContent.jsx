...
import SingleImage from '../images/wof-single.jpg';
        ...
        <div className="py-12 md:pt-20 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-lg text-slate-500">
              <h2 className="h3 font-asap-display text-slate-800 mb-4">About Black Inc.</h2>
              <p className="mb-8">
              ...
              <h3 className="flex h4 font-asap-display text-slate-800 mb-4 lg:-ml-10">
              ...
              <figure className="mb-8">
                <img className="w-full" src={SingleImage} width="768" height="432" alt="Wall of Love single" />
              </figure>
              <h3 className="flex h4 font-asap-display text-slate-800 mb-4 lg:-ml-10">
                <div className="mr-5 mt-2">
                  <svg className="fill-blue-600 shrink-0" width="20" height="16">
              ...
              <h2 className="h3 font-asap-display text-slate-800 mb-4">Conclusion</h2>
              <p className="mb-8">
...
export default WofSingleContent;