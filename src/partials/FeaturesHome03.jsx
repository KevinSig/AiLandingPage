      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-asap-display text-slate-100">Simplify operating and manage with transparency</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              <Link className="relative block group mt-8 mb-4" to="#0">
                ...
                <div className="overflow-hidden">
                  <img className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage01} width="342" height="342" alt="News 01" />
                </div>
              ...
              <h3 className="h4 font-asap-display mb-2">
                <Link className="text-slate-800 hover:underline hover:decoration-blue-100" to="#0">Advanced Features</Link>
              </h3>
            ...
            <article data-aos="fade-up" data-aos-delay="100">
              <Link className="relative block group mt-8 mb-4" to="#0">
                <div className="absolute inset-0 pointer-events-none border-2 border-slate-500 opacity-20 translate-x-4 -translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-300 ease-out -z-10" aria-hidden="true"></div>
                <div className="overflow-hidden">
                  <img className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage02} width="342" height="342" alt="News 02" />
                </div>
                <div className="w-16 h-16 absolute bg-gradient-to-b from-blue-500 to-blue-600 rounded-full -top-8 left-8">
                  <svg className="w-16 h-16 fill-current" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            ...
            <article data-aos="fade-up" data-aos-delay="200">
              <Link className="relative block group mt-8 mb-4" to="#0">
                <div className="absolute inset-0 pointer-events-none border-2 border-slate-500 opacity-20 translate-x-4 -translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-300 ease-out -z-10" aria-hidden="true"></div>
                <div className="overflow-hidden">
                  <img className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage03} width="342" height="342" alt="News 03" />
                </div>
                <div className="w-16 h-16 absolute bg-gradient-to-b from-blue-500 to-blue-600 rounded-full -top-8 left-8">
                  <svg className="w-16 h-16 fill-current" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
